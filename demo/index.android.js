  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Button
          onPress={()=>{QQ.isQQClientInstalled().then(()=>{console.log('Installed is', QQ.imageType,QQ.shareScene)}).catch(()=>{console.log('nothing')});}}
        ...
        />
        <Button
          onPress={()=>{QQ.shareAudio(audioPreviewUrl,audioUrl,imgUrl,QQ.imageType.Network,'十年','陈奕迅',QQ.shareScene.QQ).then((result)=>{console.log('result is', result)}).catch((code)=>{console.log('error is', code)});}}
